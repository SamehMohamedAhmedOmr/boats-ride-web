...
import {WaterSportBookingService} from "../../core/services/Booking/water.sport.booking.service";

@Component({
  selector: 'app-water-sport-booking-form',
  templateUrl: './water-sport-booking-form.component.html',
  styleUrls: ['./water-sport-booking-form.component.css']
})
export class WaterSportBookingFormComponent implements OnInit {
...
// @ts-ignore
  ...
  constructor(public dialogRef: MatDialogRef<WaterSportBookingFormComponent>,
              @Inject(MAT_DIALOG_DATA)
              public data: {
                water_sports: WaterSport[]
              },
              private fb: FormBuilder,
              private service: WaterSportBookingService,
  ...
  private initForm() {
    this.form = this.fb.group({
      ...
      water_sport: [null, Validators.required],
